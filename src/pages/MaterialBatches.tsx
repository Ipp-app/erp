...
interface MaterialBatchForm extends MaterialBatch {
  total_cost?: number; // This is a derived field for the form, not from DB
}
...
export default function MaterialBatches() {
  ...
  const columns = [
    ...
    { key: 'storage_location' as keyof MaterialBatch, label: 'Storage Location' },
    { 
  ...
  return (
    <div className="p-4">
      <DataTable
        ...
        searchable
        filterable
        filterOptions={{ key: 'quality_status', options: statuses }}
        paginated
        pageSize={10}
        canEdit={canEdit()}
        onAdd={() => openForm()}
      ...
      >
        ...
        />
        <ThemedSelect
          value={form.quality_status || 'in_stock'}
